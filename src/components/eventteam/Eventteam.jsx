...
const EventTeam = () => {
  return (
    <div className="eventteam" id="team">
      ...
      <div className="eventteam-title-pos">Technical Heads</div>
      <div className="eventteam-container">
          {/* <Fade direction="top" duration={2000} triggerOnce="true"> */}
        <div className="eventteam-card">
            <img
            ...
            <div className="eventteam-social">
              <a
                className="whatsapp-anchor"
                href={"mailto:suyashdashputre@gmail.com"}
                target="_blank"
                rel="noopener noreferrer"
              >
                <AiFillMail className="socialImg" />
      ...
      <div className="eventteam-title-pos">Documentation Heads</div>
      <div className="eventteam-container">
          {/* <Fade direction="top" duration={2000} triggerOnce="true"> */}
        <div className="eventteam-card">
            <img
      ...
      <div className="eventteam-title-pos">Head Editor</div>
      <div className="eventteam-container">
          {/* <Fade direction="top" duration={2000} triggerOnce="true"> */}
        <div className="eventteam-card">
            <img
