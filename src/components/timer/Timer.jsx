...
const Timer = () => {
  ...
  useEffect(() => {
    const registrationDeadline = new Date('2024-02-10T00:00:00'); // Set your registration deadline here
  ...
  return (
    ...
    <div className='headingCont'>
      ...
      <div class="apply-button" data-hackathon-slug="DEVCLASH" data-button-theme="dark">APPLY</div>
    </div>
  );
};
